  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
      ...
      <button
        ...
        className="flex items-center justify-between w-full p-5 text-left hover:bg-gray-50 transition"
      >
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-emerald-50">
            <Plus className={`w-5 h-5 text-emerald-600 transition-transform ${open ? 'rotate-45' : ''}`} />
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Move Money</h3>
            <p className="text-sm text-gray-500">Contribute or withdraw funds</p>
          </div>
        </div>
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-gray-100">
          {/* Tabs */}
          <div className="flex gap-1 mt-4 mb-5 p-1 bg-gray-100 rounded-lg w-fit">
            <button
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-7 pr-3 py-3 text-lg font-semibold border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full mt-1 px-3 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none"
                />
              </div>
              ...
              {estimate && !estimateLoading && (
                <div className={`p-4 rounded-xl border mb-4 ${
                  tab === 'contribution' ? 'bg-emerald-50/50 border-emerald-200' : 'bg-blue-50/50 border-blue-200'
                }`}>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Estimate</p>
                  <div className="space-y-1.5 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-500">Current NAV/Share</span>
                      <span className="font-semibold text-gray-900">${estimate.current_nav?.toFixed(4)}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {tab === 'withdrawal' && (
                      <>
                        {estimate.realized_gain != null && (
                          <div className="flex justify-between">
                            <span className="text-gray-500">Est. Realized Gain</span>
                        ...
                        {estimate.estimated_tax != null && (
                          <div className="flex justify-between">
                            <span className="text-gray-500">Est. Tax (quarterly)</span>
                            <span className="font-semibold text-gray-700">{formatCurrency(estimate.estimated_tax)}</span>
                          </div>
                        )}
                        {estimate.net_proceeds != null && (
                          <div className="flex justify-between pt-1.5 border-t border-gray-200">
                            <span className="text-gray-700 font-medium">Net Proceeds</span>
                            <span className="font-bold text-gray-900">{formatCurrency(estimate.net_proceeds)}</span>
                          </div>
                        )}
                      </>
                    )}
                    {tab === 'contribution' && estimate.new_total_shares != null && (
                      <div className="flex justify-between pt-1.5 border-t border-gray-200">
                        <span className="text-gray-700 font-medium">New Total Shares</span>
            ...
            <div>
              {tab === 'contribution' ? (
                <>
                  ...
                  <div className="p-4 rounded-xl border border-blue-200 bg-blue-50/50 mb-4">
                    <div className="flex items-center gap-2 mb-3">
                      <Building2 className="w-4 h-4 text-blue-600" />
                      <p className="text-sm font-bold text-blue-800">Wire/ACH Instructions</p>
                    </div>
                  ...
                  <div className="p-4 rounded-xl border border-gray-200 bg-gray-50/50">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-bold text-gray-700">How Contributions Work</p>
                    </div>
                ...
                <>
                  ...
                  <div className="p-4 rounded-xl border border-amber-200 bg-amber-50/50 mb-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-bold text-amber-800">Important: Withdrawal Timeline</p>
                    </div>
                  ...
                  <div className="p-4 rounded-xl border border-gray-200 bg-gray-50/50">
                    <div className="flex items-center gap-2 mb-3">
                      <Info className="w-4 h-4 text-gray-500" />
                      <p className="text-sm font-bold text-gray-700">Tax Information</p>
                    </div>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Total In</span>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Total Out</span>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Net Invested</span>
        </div>
        <p className="text-xl font-bold text-gray-900">{formatCurrency(net)}</p>
      </div>
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">P/L Total</span>
        </div>
        {plTotal !== null ? (
          <>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Transactions</span>
        </div>
      ...
      <ResponsiveContainer width="100%" height={220}>
        <BarChart data={chartData} margin={{ top: 5, right: 5, bottom: 5, left: 5 }}>
          ...
          <YAxis
            ...
            width={50}
          />
          <ReTooltip content={<CashFlowTooltip />} cursor={{ fill: 'rgba(0,0,0,0.03)' }} />
...
const STATUS_CONFIG = {
  pending:        { label: 'Pending',        color: 'text-amber-600',   bg: 'bg-amber-50',   border: 'border-amber-200',   icon: Clock,         dot: 'bg-amber-400' },
  approved:       { label: 'Approved',       color: 'text-blue-600',    bg: 'bg-blue-50',    border: 'border-blue-200',    icon: CheckCircle2,  dot: 'bg-blue-400' },
  awaiting_funds: { label: 'Awaiting Funds', color: 'text-purple-600',  bg: 'bg-purple-50',  border: 'border-purple-200',  icon: RefreshCw,     dot: 'bg-purple-400' },
  matched:        { label: 'Matched',        color: 'text-indigo-600',  bg: 'bg-indigo-50',  border: 'border-indigo-200',  icon: CircleDot,     dot: 'bg-indigo-400' },
  processed:      { label: 'Completed',      color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-200', icon: CheckCircle2,  dot: 'bg-emerald-400' },
  rejected:       { label: 'Rejected',       color: 'text-red-600',     bg: 'bg-red-50',     border: 'border-red-200',     icon: XCircle,       dot: 'bg-red-400' },
  cancelled:      { label: 'Cancelled',      color: 'text-gray-500',    bg: 'bg-gray-50',    border: 'border-gray-200',    icon: XCircle,       dot: 'bg-gray-400' },
};
        ...
        return (
          <div key={step} className="flex items-center flex-1">
            <div className={`h-1.5 w-full rounded-full transition-all duration-500 ${
              isActive ? config.dot : isTerminal ? 'bg-gray-200' : 'bg-gray-200'
...
const FundFlowCard = ({ request }) => {
  ...
  return (
    <div className={`bg-white rounded-xl border shadow-sm p-4 hover:shadow-md transition-shadow ${
      request.status === 'processed' ? 'border-emerald-100' :
      request.status === 'rejected' || request.status === 'cancelled' ? 'border-gray-200 opacity-75' :
      'border-gray-100'
    }`}>
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          <div className={`p-1.5 rounded-lg ${isContribution ? 'bg-emerald-50' : 'bg-red-50'}`}>
            {isContribution
          ...
          <div>
            <span className={`text-sm font-bold ${isContribution ? 'text-emerald-700' : 'text-red-700'}`}>
              {isContribution ? 'Contribution' : 'Withdrawal'}
            </span>
            <p className="text-[10px] text-gray-400">Requested {formatDate(request.request_date)}</p>
          </div>
        </div>
      ...
      <div className="flex items-baseline gap-2 mb-2">
        ...
        {request.actual_amount && request.actual_amount !== request.requested_amount && (
          <span className="text-xs text-gray-400">(Actual: {formatCurrency(request.actual_amount)})</span>
        )}
      </div>
        ...
        <div className="mt-3 pt-3 border-t border-gray-100 grid grid-cols-2 gap-2 text-xs">
          ...
          {request.nav_per_share != null && (
            <div>
              ...
              <p className="font-semibold text-gray-700">${request.nav_per_share.toFixed(4)}</p>
            </div>
          )}
          {request.processed_date && (
            <div>
              <span className="text-gray-400">Completed</span>
              <p className="font-semibold text-gray-700">{formatDate(request.processed_date)}</p>
            </div>
          )}
          {!isContribution && request.realized_gain != null && (
            <div>
              <span className="text-gray-400">Realized Gain</span>
...
const TYPE_ICONS = {
  Initial: { icon: DollarSign, color: 'text-blue-600', bg: 'bg-blue-50' },
  Contribution: { icon: ArrowDownRight, color: 'text-emerald-600', bg: 'bg-emerald-50' },
  Withdrawal: { icon: ArrowUpRight, color: 'text-red-600', bg: 'bg-red-50' },
  Tax_Payment: { icon: FileText, color: 'text-amber-600', bg: 'bg-amber-50' },
  Fee: { icon: FileText, color: 'text-gray-600', bg: 'bg-gray-50' },
  Adjustment: { icon: RefreshCw, color: 'text-purple-600', bg: 'bg-purple-50' },
};
        ...
        <>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {tx.notes && (
                        <span className="text-[10px] text-gray-400 truncate max-w-[200px]" title={tx.notes}>
                          {tx.notes}
                        </span>
                      )}
                    </div>
                    <div className="flex items-center gap-3 text-xs text-gray-500">
                      ...
                      <span className="text-gray-400">@ ${tx.nav_at_transaction?.toFixed(4) || '--'}</span>
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
            <button
              ...
              disabled={page === 0}
              className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium transition disabled:opacity-30 disabled:cursor-not-allowed bg-gray-100 text-gray-600 hover:bg-gray-200"
            >
...
const ActivityPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20 lg:pb-8">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">My Money</h2>
        <p className="text-gray-500 text-sm">Your contributions, withdrawals, and fund flow history</p>
      </div>
